        ...
        <div id="about" className="my-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="p-4">
                    ...
                    <div className="">
                        <h3 className="text-2xl lg:text-3xl text-white font-bold">Programming Tools</h3>
                        <div className="my-4">
                            <ul className="flex py-4 text-5xl lg:text-6xl gap-4">
                    ...
                    <div className="my-4">
                        <h3 className="text-2xl lg:text-3xl text-white font-bold">UI Libraries</h3>
                        <div className="">
                            <ul className="flex py-4 text-5xl lg:text-6xl gap-4">
                    ...
                    <div className="my-4">
                        <h3 className="text-2xl lg:text-3xl py-4 text-white font-bold">Design Tools</h3>
                        <div className="">
                            <ul className="flex text-5xl lg:text-6xl gap-4">
