...
const About = () => {
    ...
    return (
        <div id="about" className="my-20">
            <h3 className="text-6xl uppercase text-center lg:text-start p-4 my-10 font-bold">About me</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="">
                    <div className="p-4 w-full max-w-6xl">
                        ...
                        <p className="text-2xl py-4">I was born in Tehran, Iran, where the culture and traditions shaped my perspective on life. Moving to the United States in the fourth grade taught me resilience and adaptability, helping me navigate a new environment while holding onto my roots. This blend of experiences has shaped who I am today.</p>
                        <p className="text-2xl py-4">My passion for programming began during the COVID-19 pandemic. Over the past four years, I’ve specialized in Python, JavaScript, and web development, creating tools like KitCraft and automating tasks with APIs. Programming has become my way of solving problems and building meaningful solutions.</p>
                        <p className="text-2xl py-4">I’m deeply passionate about helping small businesses grow. Using my technical skills, I enjoy creating tools and systems that help entrepreneurs overcome challenges and scale effectively. Supporting their success drives me to continue innovating and making a difference.</p>
                ...
                <div className="p-4">
                    ...
                    <div className="">
                        <h3 className="text-3xl text-white font-bold">Programming Tools</h3>
                        <div className="my-4">
                            <ul className="flex py-4 text-6xl gap-4">
                    ...
                    <div className="my-4">
                        <h3 className="text-3xl text-white font-bold">UI Libraries</h3>
                        <div className="">
                            <ul className="flex py-4 text-6xl gap-4">
                    ...
                    <div className="my-4">
                        <h3 className="text-3xl py-4 text-white font-bold">Design Tools</h3>
                        <div className="">
                            <ul className="flex text-6xl gap-4">
